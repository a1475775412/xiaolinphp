...
class IndexController{
	...
	public function sysinfo(){
		...
		sysinfo([
			...
			'more'	=> [
				'By.XiaoLin',
				'<a href="https://github.com/XiaoLin/xiaolin" target="_blank">https://github.com/XiaoLin/xiaolin</a>',
				'https://xlch.me/',
				'第四条提示语'
			]
		]);
