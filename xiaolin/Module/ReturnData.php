...
class ReturnData{
	...
	static public function sysinfo($args = []){
		...
		include(xiaolin . 'Template/sysinfo.php');
		
		/* 性能统计 END */
		\XiaoLin\Module\PerformanceStatistics::log('END');
		\XiaoLin\Module\PerformanceStatistics::show();
		die();
	}
	...
	static public function notice($notice, $go = '', $time = 0){
		...
		extract($notice);
		include(xiaolin . 'Template/notice.php');
