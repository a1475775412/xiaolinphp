...
class Language {
	...
	static private $path		= [
		xiaolin . 'Language' . DIRECTORY_SEPARATOR
	];
	 ...
	 * @return void
	 */
	public static function init($custom = 'zh-CN', $cookieName = 'xiaolin_language', $subfix = '.php'){
	...
	private static function initLanguages(){
		if(isset($_COOKIE[self::$cookieName])){
			self::$languages[] = self::format($_COOKIE['xiaolin_language']);
		}
