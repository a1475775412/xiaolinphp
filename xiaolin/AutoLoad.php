...
use XiaoLin\Exception\AutoLoadException;
...
class AutoLoad{
	...
	public static function init(){
		spl_autoload_register(['\\XiaoLin\\AutoLoad', 'load']);
		self::register('', xiaolin . 'Libraries', 'none');
		self::register('XiaoLin', xiaolin, 'none');
	}
