...
if(!function_exists('view')){
	...
	function view($templateFile_, $args = [], $isRoot = false){
		return \XiaoLin\View::view($templateFile_, $args, $isRoot);
	}
}
...
if(!function_exists('url')){
	...
	function url($router = '', $args = ''){
		return \XiaoLin\Router::url($router, $args);
	}
}
...
if(!function_exists('do_hook')){
	...
	function do_hook($id, $args = []){
		return \XiaoLin\Hook::do($id, $args);
	}
}
...
if(!function_exists('add_hook')){
	...
	function add_hook($id, $function){
		return \XiaoLin\Hook::add($id, $function);
	}
}
...
if(!function_exists('i')){
	...
	function i($i, $method = 'all', $filter = '', $default = ''){
		...
		switch($method){
			...
			case 'args':
				$return = isset(\XiaoLin\Router::$args[$i]) ? \XiaoLin\Router::$args[$i] : $default;
			break;
...
if(!function_exists('l')){
	...
	function l($value, $args = [], $default = null){
		return \XiaoLin\Module\Language::languagePrintf($value, $args, $default);
	}
}
...
if(!function_exists('cache')){
	...
	function cache(string $key, $value = null, $expiry = false){
		if($value === FALSE){
			return \XiaoLin\Module\Cache::delete($key);
		}else if($value === null){
			return \XiaoLin\Module\Cache::get($key);
		}else{
			return \XiaoLin\Module\Cache::set($key, $value, $expiry);
		}
	}
}
...
if(!function_exists('getCache')){
	...
	function getCache($key, $value = null){
		return \XiaoLin\Module\Cache::get($key, $value);
	}
}
...
if(!function_exists('notice')){
	...
	function notice($notice, $go = '', $time = 0){
		\XiaoLin\Module\ReturnData::notice($notice, $go = '', $time = 0);
	}
}
...
if(!function_exists('sysinfo')){
	...
	function sysinfo($args = []){
		\XiaoLin\Module\ReturnData::sysinfo($args);
	}
}
if(!function_exists('set_http_code')){
	...
	function set_http_code($code) {
		\XiaoLin\Module\ReturnData::set_http_code($code);
	}
}
...
if(!function_exists('go')){
	...
	function go($url, $type = 302){
		\XiaoLin\Module\ReturnData::go($url, $type = 302);
	}
}
...
if(!function_exists('returnData')){
	...
	function returnData($data = '', $status = 'success', $msg = '', $code = '', $dataType = true){
		\XiaoLin\Module\returnData::returnData($status, $msg, '', $data, '', '', 0, $dataType);
	}
}
...
if(!function_exists('returnSuccess')){
	...
	function returnSuccess($msg = '', $title = '', $data = '', $code = '', $url = '', $wait = null, $onlyData = false){
		\XiaoLin\Module\returnData::returnData('success', $msg, $title, $data, $code, $url, $wait, $onlyData);
	}
}
...
if(!function_exists('returnError')){
	...
	function returnError($msg = '', $title = '', $data = '', $code = '', $url = '', $wait = null, $onlyData = false){
		\XiaoLin\Module\returnData::returnData('error', $msg, $title, $data, $code, $url, $wait, $onlyData);
	}
}
...
if(!function_exists('returnInfo')){
	...
	function returnInfo($msg = '', $title = '', $data = '', $code = '', $url = '', $wait = null, $onlyData = false){
		\XiaoLin\Module\returnData::returnData('info', $msg, $title, $data, $code, $url, $wait, $onlyData);
	}
}
...
if(!function_exists('returnStatus')){
	...
	function returnStatus($status, $msg = '', $title = '', $data = '', $code = '', $url = '', $wait = null, $onlyData = false){
		\XiaoLin\Module\returnData::returnData($status, $msg, $title, $data, $code, $url, $wait, $onlyData);
	}
}


//========================================================================================
//==== XiaoLin Controller return支持 ====================================================
//========================================================================================
...
if(!function_exists('success')){
	 ...
	 * @param int    $wait     等待时间
	 * @param mixed	 $dataType 是否为输出数据，若为true，则根据客户端请求自动返回json/jsonp/xml (不会返回提示页面)，也可直接填入返回类型，将强制返回该类型数据。
	 * @return \XiaoLin\Model\ControllerReturn
	 */
	function success($msg = '', $title = '', $data = '', $code = '', $url = '', $wait = null, $onlyData = false){
		return new \XiaoLin\Model\ControllerReturn('status_success', func_get_args());
	}
}
...
if(!function_exists('error')){
	...
	function error($msg = '', $title = '', $data = '', $code = '', $url = '', $wait = null, $onlyData = false){
		return new \XiaoLin\Model\ControllerReturn('status_error', func_get_args());
	}
}
...
if(!function_exists('info')){
	...
	function info($msg = '', $title = '', $data = '', $code = '', $url = '', $wait = null, $onlyData = false){
		return new \XiaoLin\Model\ControllerReturn('status_info', func_get_args());
	}
}
...
if(!function_exists('json')){
	 ...
	 */
	function json($data){
		return new \XiaoLin\Model\ControllerReturn('data_json', func_get_args());
	}
}
...
if(!function_exists('jsonp')){
	...
	function jsonp($arr, $key = ''){
		return new \XiaoLin\Model\ControllerReturn('data_jsonp', func_get_args());
	}
}
...
if(!function_exists('xml')){
	...
	function xml($arr, $root = null){
		return new \XiaoLin\Model\ControllerReturn('data_xml', func_get_args());
	}
}