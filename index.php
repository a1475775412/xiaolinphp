...
// 引入框架文件
include(root . 'xiaolin' . DIRECTORY_SEPARATOR . 'Init.php');

// 启动 (<ゝω·)☆
\XiaoLin\XiaoLin::init(array(
	/* 定义APP以及模板目录 */
	'path'		=> [
	...
	*/
	...
	'AntiCSRF'	=> [
		'enable'		=> true,				//启用
		'cookieName'	=> 'xiaolin_formhash',	//COOKIE 键名
		'sessionName'	=> 'xiaolin_formhash',	//SESSION 键名
	...
	'language'	=> [
		'use'			=> 'zh-CN',				//程序使用的默认语言
		'cookieName'	=> 'xiaolin_language'	//用于记录用户自定义语言的COOKIE键名
	],
